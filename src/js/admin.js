...
async function updateData(formData) {
	...
	try {
		...
		if (response.ok && responseData.success) {
			...
			feedbackText.innerHTML = `<br><mark>slaapplek ${nr} toegevoegd met coordys: ${responseData.added.lat},${responseData.added.lon} in ${responseData.added.country} ${responseData.added.flag}</mark>`;
			...
			feedbackText.innerHTML = `<br><mark>Fout: ${responseData.error || "Onbekende fout"}</mark>`;
		...
		feedbackText.innerHTML = `<br><mark>Serverfout: ${error.message}</mark>`;
